            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
              ...
              <div className="flex justify-center">
                <div className="relative w-full max-w-[500px]">
                  ...
                  <div className="aspect-square w-full">
                    <img
                      className="w-full h-full rounded-2xl object-cover border-8 border-white shadow-2xl 
                     transition-all duration-500 hover:scale-[1.02] hover:border-gray-100 
                     hover:shadow-3xl hover:shadow-blue-400/20"
                      src={doctorData.avatar || '/default-doctor-image.png'}
                      alt={`Dr. ${doctorData.name}`}
                      loading="lazy"
                    />
                    {/* Decorative Elements */}
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-t from-black/20 to-transparent opacity-0 transition-opacity duration-300 hover:opacity-100" />
                    <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 transition-opacity duration-300 hover:opacity-100">
              ...
              <div className="grid gap-4 text-center md:text-left">
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <span className="text-gray-900 text-xl font-semibold">₹{doctorData.fees}</span>
                </div>

                <div className="flex flex-col space-y-1">
                  <span className="text-gray-600 font-medium">Location</span>
                  <span className="text-gray-900">{doctorData.city}</span>
                </div>
              </div>

              <div className="pt-6">
                <Link href={`/user/appointment/${doctorData._id}`}>
                  <button className="w-full md:w-auto px-8 py-3 bg-blue-600 text-white font-semibold 
           rounded-full transition-all duration-300 hover:bg-blue-700 
