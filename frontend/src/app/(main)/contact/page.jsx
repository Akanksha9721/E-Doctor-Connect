        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex md:items-center md:space-x-8">
              <Link href="/user/profile" className="text-white font-medium hover:text-blue-400 transition-colors">
                PROFILE
              </Link>
              ...
              <Link href="/user/blog" className="text-white font-medium hover:text-blue-400 transition-colors">
                BLOG
              </Link>
            </div>
          </div>
