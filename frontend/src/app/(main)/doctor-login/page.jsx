...
const Login = () => {
    ...
    return (
        <>
            <div className='bg-blue-200 bg-cover h-screen py-10 '>
                <h1 className="block font-bold   text-center text-2xl font-bold text-gray-800 dark:text-white">
                    Doctor-Login
                </h1>
                <div className=" mt-10 max-w-xl mx-auto  bg-white  border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
