...
const Aboutpage = () => {
    ...
    return (
        <>
                ...
                <div className="mx-auto max-w-screen px-4 md:px-5 md:px-10 ">
                    ...
                    <div className="grid gap-10 md:grid-cols-2 lg:gap-15 xl:gap-20 2xl:gap-24">
                        ...
                        <div className='md:pt-8'>
                            ...
                            <h2 className='font-bold text-center text-blue-500 uppercase  text-4xl'>
                                About us
                            </h2>
                            <p className="mb-6 py-4 text-gray-500 sm:text-lg md:mb-8 font-medium ">
            ...
            <div className="bg-blue-800 mt-16  py-10 px-4 md:px:8 lg:px-12 xl:px-16 2xl:px-24  ">
