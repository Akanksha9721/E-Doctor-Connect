    ...
    <>
      ...
      <div className='   w-full  mx-auto py-0'>
        ...
        <a
          ...
          href="#"
        >
          <div className="   flex justify-center items-center  px-10  bg-green-100 relative flex items-center overflow-hidden">
            <img
              className=" w-32 h-32 rounded-full  object-cover sm:w-48  absolute inset-0 object-cover rounded-s-lg"
