      ...
      <section className="py-16 bg-white">
        <div className=" px-4 md:px-6">
              ...
              <div key={i} className="group">
                <div className="relative overflow-hidden rounded-xl shadow-md mb-4">
                  <div className="aspect-[3/4]">
                    <Image
                      src={`/placeholder.svg?height=600&width=450&text=Doctor+${i}`}
                      alt={`Team member ${i}`}
                      fill
                ...
                <h3 className="text-lg font-semibold group-hover:text-blue-600 transition-colors">Dr. John Smith</h3>
          ...
          <div className="text-center mt-12">
            <Button asChild>
              <Link href="/browse-doctor" className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="text-center md:text-left mb-8">
                ...
                <div className="h-1 w-20 bg-blue-600 md:mx-0 mx-auto"></div>
              </div>

              <div className="space-y-4">
                {[
                  { question: "Why choose e-Doctor?", id: "faq-1" },
                  { question: "Who can access e-Doctor services?", id: "faq-2" },
                  { question: "Are telehealth services covered by Medicare?", id: "faq-3" },
                  { question: "How long till a Doctor responds?", id: "faq-4" },
                ].map((faq) => (
                  <div key={faq.id} className="rounded-lg border shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="mt-8 text-center md:text-left">
                ...
                <p className="text-sm text-gray-500 mt-2">Have medical questions? Our doctors are here to help.</p>
              </div>
            </div>
          </div>
        </div>
