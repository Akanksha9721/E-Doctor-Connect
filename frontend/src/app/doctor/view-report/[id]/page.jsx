                        ...
                        <div className="grid sm:grid-cols-12 gap-2 sm:gap-6">
                          ...
                          <div className="sm:col-span-3">
                            ...
                            <label
                              ...
                              className="inline-block text-xl  font-bold   text-gray-800 mt-2.5 dark:text-neutral-200"
                            >
                              prescription
                            </label>
                          ...
                          <div className="sm:col-span-7">
                            <div className="sm:flex">
                              <textarea
                                ...
                                className=" w-full border border-gray-300 p-2 rounded-md focus:ring focus:ring-blue-300 outline-none mb-3 sm:md-0 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-nertral-600"
                          ...
                          <div className="sm:col-span-9">
                            ...
                            <div className="sm:flex grid grid-cols-6 gap-20 text-xl font-bold text-gray-800 space-x-2  mt-2.5 dark:text-red-200 ">
                              {
                                testList.map(
                                  test => (
