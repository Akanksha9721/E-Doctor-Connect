...
const viewAppointment = () => {
  ...
  return (
    <>
      <div className="bg-gray-100 bg-cover bg-no-repeat bg-center bg-fixed bg-gray-100 ">

      <h1 className=' py-8 text-center font-bold   text-blue-800 text-4xl uppercase'>DOCTOR DASHBOARD</h1>
      ...
      <div className='flex justify-center items-center h-screen  bg-gray-100'>
        <div className='p-4 h-[700px]  w-[900px]   space-y-6 text-center py-20  bg-gray-100'>
          <div className="space-y-1 md:space-y-2">
            <h2 className="font-bold text-4xl lg:text-4xl text-blue-800 dark:text-neutral-200 text-center">
             ID: {appointmentData._id}
            </h2>
          </div>
          
        <p className='font-bold  text-3xl py-5'> Name : {appointmentData.patientName}</p>
          <p className='font-bold text-3xl py-5'> Age : {appointmentData.patientAge}</p>
          <p className='font-bold text-3xl py-5'> Gender : {appointmentData.patientGender}</p>
          <p className='font-bold text-3xl py-5'>Description:{appointmentData.description}</p>
